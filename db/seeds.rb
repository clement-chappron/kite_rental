...
product1 = Product.create!(
  ...
  price_per_day: 30,
  address: "Jules Koenig Street, Port Louis, Mauritius",
  user_id: user1.id
)
...
product4 = Product.create!(
  ...
  price_per_day: 40,
  address: "Royal Road, Vacoas, Mauritius",
  user_id: user2.id
)
...
product5 = Product.create!(
  ...
  price_per_day: 65,
  address: "Royal Road, Rose Hill, Mauritius",
  user_id: user2.id
)
...
product6 = Product.create!(
  ...
  price_per_day: 45,
  address: "St Pierre, Moka, Mauritius",
  user_id: user1.id
)
...
product7 = Product.create!(
  ...
  price_per_day: 55,
  address: "Centre de Flacq, Mauritius",
  user_id: user2.id
)
...
product8 = Product.create!(
  ...
  price_per_day: 50,
  address: "Royal Road, Mahebourg, Mauritius",
  user_id: user1.id
)
...
product10 = Product.create!(
  ...
  price_per_day: 40,
  address: "Royal Road, Rivière du Rempart, Mauritius",
  user_id: user2.id
)
...
product11 = Product.create!(
  ...
  price_per_day: 50,
  address: "Royal Road, Souillac, Mauritius",
  user_id: user1.id
)
...
product13 = Product.create!(
  name: "Slingshot Raptor",
  description: "La Slingshot Raptor est une voile dédiée au big air, offrant une portance exceptionnelle et une stabilité inégalée. C'est le choix des riders cherchant à repousser leurs limites en hauteur.",
  price_per_day: 60,
  user_id: user1.id,
...
product14 = Product.create!(
  name: "Naish Boxer",
  description: "La Boxer de Naish est une voile mono-latte légère, parfaite pour le foil et les vents légers. Sa conception minimaliste permet une maniabilité fluide et réactive.",
  price_per_day: 35,
  user_id: user2.id,
  address: "Royal Road, Curepipe, Mauritius"
)
...
product15 = Product.create!(
  name: "F-One Breeze",
  description: "La F-One Breeze est conçue pour exceller dans les conditions de vent faible. Sa légèreté et sa réactivité en font une voile idéale pour le foil et le freeride par vents légers.",
  price_per_day: 45,
  user_id: user2.id,
  address: "St. Jean Road, Quatre Bornes, Mauritius"
)
...
product16 = Product.create!(
  name: "Ozone Catalyst",
  description: "L'Ozone Catalyst est une voile facile à prendre en main, parfaite pour les débutants et intermédiaires. Sa construction robuste et sa stabilité en font un choix sûr pour progresser en toute confiance.",
  price_per_day: 40,
  user_id: user1.id,
  address: "Royal Road, Vacoas, Mauritius"
)
...
product17 = Product.create!(
  name: "North Carve",
  description: "La North Carve est spécialement conçue pour le surf, offrant un drift incroyable et une maniabilité précise. Elle est parfaite pour ceux qui cherchent à dompter les vagues avec style.",
  price_per_day: 50,
  user_id: user2.id,
  address: "Royal Road, Rose Hill, Mauritius"
)
...
product18 = Product.create!(
  name: "Duotone Dice",
  description: "La Duotone Dice est une voile de freestyle agile et réactive, offrant des performances de pointe pour les tricks et les figures aériennes. Elle est idéale pour les riders créatifs.",
  price_per_day: 55,
  user_id: user1.id,
  address: "St Pierre, Moka, Mauritius"
)
...
product19 = Product.create!(
  name: "Liquid Force Solo",
  description: "La Liquid Force Solo est une voile minimaliste, conçue pour être légère et facile à manipuler. Parfaite pour le foil, elle excelle également dans les vents légers.",
  price_per_day: 35,
  user_id: user2.id,
  address: "Centre de Flacq, Mauritius"
)
...
product20 = Product.create!(
  name: "Core GTS5",
  description: "La Core GTS5 est une voile de freestyle polyvalente, connue pour sa puissance explosive et son loop précis. Idéale pour les riders recherchant des sensations fortes.",
  price_per_day: 60,
  user_id: user2.id,
  address: "Royal Road, Mahebourg, Mauritius"
)
...
product21 = Product.create!(
  name: "Ozone Reo V5",
  description: "L'Ozone Reo V5 est la voile de référence pour le wave riding. Sa capacité à drifter et sa stabilité dans les vagues en font un choix incontournable pour les surfeurs expérimentés.",
  price_per_day: 50,
  user_id: user1.id,
  address: "Royal Road, Pamplemousses, Mauritius"
)
...
product22 = Product.create!(
  name: "North Neo",
  description: "La North Neo est une voile de surf très réactive, offrant un excellent contrôle dans les vagues. Son drift exceptionnel en fait une alliée de choix pour les sessions en mer agitée.",
  price_per_day: 55,
  user_id: user2.id,
  address: "Royal Road, Rivière du Rempart, Mauritius"
)
...
product23 = Product.create!(
  name: "F-One WTF",
  description: "La F-One WTF est une voile de freestyle conçue pour les riders les plus exigeants. Avec une réactivité et une puissance sans compromis, elle est idéale pour le big air et les figures extrêmes.",
  price_per_day: 60,
  user_id: user1.id,
  address: "Royal Road, Souillac, Mauritius"
)
...
product24 = Product.create!(
  name: "Cabrinha Moto",
  description: "La Cabrinha Moto est une voile polyvalente, idéale pour ceux qui cherchent à tout faire. Freeride, freestyle, ou surf, elle offre des performances solides dans toutes les disciplines.",
  price_per_day: 45,
  user_id: user2.id,
  address: "Bambous, Mauritius"
)
